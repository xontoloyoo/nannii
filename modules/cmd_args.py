...
parser.add_argument("--medvram", action='store_true', help="enable sdw model optimizations for sacrificing a little speed for low VRM usage")
...
parser.add_argument("--lowram", action='store_true', help="load sdw checkpoint weights to VRAM instead of RAM")
