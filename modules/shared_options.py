...
options_templates.update(options_section(('sd', "sdw"), {
    "sd_model_checkpoint": OptionInfo(None, "sdw checkpoint", gr.Dropdown, lambda: {"choices": shared_items.list_checkpoint_tiles()}, refresh=shared_items.refresh_checkpoints, infotext='Model hash'),
